...
import sensorsRoute from './routes/sensors.js';   // API Sensors mới (definitions + records + JWT)
import authRoute from './routes/auth.js';          // API đăng nhập lấy JWT token

mongoose.connect(MONGO_URI)
    .then(() => console.log('✅ Đã kết nối với MongoDB (spirulina_db) thành công'))
